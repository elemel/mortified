...
namespace mortified {
    ...
    void PhysicsDraw::DrawPolygon(b2Vec2 const *vertices,
    ...
    void PhysicsDraw::DrawSolidPolygon(b2Vec2 const *vertices,
        int32 vertexCount, b2Color const &color)
    {
        DrawPolygon(vertices, vertexCount, color);
    }

    void PhysicsDraw::DrawCircle(b2Vec2 const &center,
    ...
    void PhysicsDraw::DrawSolidCircle(b2Vec2 const &center,
    ...
    void PhysicsDraw::DrawSegment(b2Vec2 const &p1,
    ...
    void PhysicsDraw::DrawTransform(b2Transform const &transform)
    {
